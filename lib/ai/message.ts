import type { ChatMessageProps } from "@/lib/zod";
import {
...
export async function generateSimilarQuestions({
  ...
  const { object } = await generateObject({
    ...
    prompt: `Analyze this query: "${question}". Provide the following:
...
export function convertToUIMessages(messages: Array<ChatMessageProps>): Array<Message> {
