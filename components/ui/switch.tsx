...
export function Switch({
  ...
  const switchRoot = (
    <SwitchPrimitive.Root
      ...
      className={cn(
        "relative inline-flex h-4 w-8 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent radix-state-checked:bg-blue-500 radix-state-unchecked:bg-gray-200 transition-colors duration-200 ease-in-out",
    ...
    >
      <SwitchPrimitive.Thumb
        className={cn(
          ...
          `pointer-events-none size-3 translate-x-4 transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out`,
          thumbDimensions,
          thumbTranslate,
        )}
      />
