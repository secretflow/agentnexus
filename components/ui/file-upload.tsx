    ...
    >
      ...
      <div
        className={cn(
          ...
          disabled && "bg-gray-50",
          dragActive && !disabled && "cursor-copy border-2 border-black bg-gray-50 opacity-100",
          imageSrc
      ...
      >
        ...
        {content !== null && (
          <div
            className={cn("mt-2 text-center text-gray-500 text-sm", disabled && "text-gray-400")}
          >
            {content ?? (
              <>
